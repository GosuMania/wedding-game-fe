...
@Component({
  selector: 'app-game',
  templateUrl: './game-user-detail.page.html',
  styleUrls: ['./game-user-detail.page.scss'],
})
export class GameUserDetailPage implements OnInit, OnDestroy {
  ...
  constructor(private us: UserService, private gs: GameService, public fb: UntypedFormBuilder, private spinnerService: SpinnerService,
      ...
      if (this.us.userDetail) {
        ...
        this.router.navigate(['/classifica'], {replaceUrl: true})
      }
